...
export default function AuthModal() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-fade-in font-sans">
      {/* Centered Modal Card - Compact 1-Screen Fit */}
      <div className="relative w-full max-w-md bg-[#070709] border border-white/20 p-5 sm:p-6 text-white flex flex-col gap-3.5 shadow-2xl max-h-[94vh] overflow-y-auto custom-scrollbar">
        ...
        {/* Subtle SpaceX-style corners */}
        <div className="absolute top-0 left-0 w-2.5 h-2.5 border-t-2 border-l-2 border-white/60" />
        <div className="absolute top-0 right-0 w-2.5 h-2.5 border-t-2 border-r-2 border-white/60" />
        <div className="absolute bottom-0 left-0 w-2.5 h-2.5 border-b-2 border-l-2 border-white/60" />
        ...
        <div className="bg-white/[0.04] border border-white/15 p-2.5 text-xs">
          ...
          <p className="text-white/70 text-[11px] leading-relaxed font-sans">
            {authModalReason ||
              "Sign in to continue using SatQuery AI. Unlock unlimited satellite analyses, high-res segmentation, and RFC 7946 GeoJSON exports."}
          </p>
        </div>
