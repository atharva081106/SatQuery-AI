      ...
      <div className="relative w-full max-w-md bg-white/[0.04] backdrop-blur-3xl border border-white/25 rounded-3xl p-5 sm:p-7 text-white flex flex-col gap-4 shadow-[0_20px_50px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.25)] max-h-[90dvh] overflow-y-auto custom-scrollbar">
        ...
        <div className="flex items-start justify-between border-b border-white/15 pb-3">
          <div>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-white animate-pulse shadow-[0_0_8px_#34d399]" />
        ...
        {queryCount >= maxFreeQueries && (
          <div className="bg-white/[0.06] backdrop-blur-xl border border-white/15 rounded-2xl p-3.5 text-xs shadow-inner">
            <div className="flex items-center justify-between text-[10px] font-mono font-bold text-white tracking-wider uppercase mb-1">
        ...
        <div className="border-t border-white/10 pt-3 flex flex-col gap-2">
          <button
            ...
            className="w-full py-2.5 bg-white/15 hover:bg-white/25 border border-white/40 text-white/80 rounded-2xl text-[11px] font-mono font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md"
          >
            <span>⚡</span>
